...
### 10. Duplicate back buttons (4 components)
- Each component had hidden mobile Kembali button using dead window.history.back(). App.tsx already handles back nav. Removed duplicates.

### 11. StatsDashboard.tsx — Invalid Tailwind class
